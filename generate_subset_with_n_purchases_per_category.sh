#!/bin/bash
files=`ls datasets -ls | grep -v '^total' | awk '{print $10}'`
...
do
    ...
    sub_dataset_with_purchases_file_path="purchases/$file_base.purchases.csv"
    ...
    list_of_purchases_categories_file_path="purchases/$file_base.purchases-categories.csv"
    ...
    aggregated_n_purchases_per_category_file_path="purchases/$file_base.purchases-per-category.csv"
